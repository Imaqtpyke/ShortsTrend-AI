...
export function TabButton({ active, onClick, icon, label, disabled = false, theme }: { active: boolean, onClick: () => void, icon: React.ReactNode, label: string, disabled?: boolean, theme: any }) {
    return (
        <button
            onClick={onClick}
            disabled={disabled}
